...
NumSampleMin = 1
NumSampleMax = 2   #WE CURRENTLY CUT the samples in this program, don't nec need to #Using 8 gives cutlength = 2048 > the actual gene length, which is why the program fills it 
...
print "b0 = ", b0, " and cutgenelength = ", cutgenelength, " is the number of base pairs from each of the Ngenes = ", Ngenes, " number of samples"
...
#                V[i][j] = V[i][j]
    ...
    #print M
    print "For the int(b-B)+1 = ", int(b-B)+1, "-th SVD there are", len(Lambda), "singular values and they are:" #i.e. for W_(b-B) = U.Lambda_(b-B).V, the non-zero values of Lambda_(b-B)
...
print "The list of Lambdas: ", LAM
print "The list of Gammas: ", GAMMA
